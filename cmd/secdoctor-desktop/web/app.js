...
const $=s=>document.querySelector(s),esc=v=>String(v??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[c]));let vulns=[],filter="ALL",currentPlan=null,lastBefore=0;
...
$("#applyFix").onclick=async()=>{
 ...
 try{
  ...
  const planID=currentPlan.id;$("#fixplan").classList.add("hidden");
